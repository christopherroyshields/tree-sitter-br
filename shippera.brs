...
35206       let FNDISPLAY_WINDOW=TRUE       !Assume success !:
            ...
            let FNMAKE_FRAME(MAT DUMMY$,5,DUMMY+2,"и╪",TITLE$) !:
...
44406       let FNLINE_INPUT$=NULL$         !Assume error !:
            ...
            let FNMAKE_FRAME(MAT DUMMY$,3,DUMMY,"зы",TITLE$) !:
...
46608       let FNMAKE_FRAME(MAT F$,9,24,FRAME$,TITLE$) !:
            let F$(2)="Ё.Su.Mo.Tu.We.Th.Fr.Sa,Ё" !:
...
51614       do  !:
               ...
               if _PAGES>1 then !:
                  ...
                  print #WINDOW,fields WORK$: RPT$("д",10)
...
76170       if F(SALES_TYPE_SH) then !                               Return to vendor !:
               ...
               let SHHW$(2)(25:33) = "Vendor" & NORMAL$ & "дд" !:
            else !:
               let SHHW$(2)(25:33) = "Customer" & NORMAL$
...
99770       let WORK$=RPT$("д",37)&RPT$("Ё",32)&RPT$("д",37)  !Frame !:
            let WORK$(1:1)="з" !:
            let WORK$(37:37)="б" !:
            let WORK$(41:41)=WORK$(43:43)=WORK$(53:53)="ц" !:
            let WORK$(63:63)=WORK$(65:65)="ц" !:
            let WORK$(70:70)="ю" !:
            let WORK$(106:106)="а"
...
99812          mat PAS_SPEC$(1)=(NULL$) !:
               ...
               let DUMMY=FNPAS(WINDOW,MAT CLAUSE_LST$,MAT PAS_SPEC$,MAT BLANK$,CLAUSE_PAS,5,2,10,3,24,"Clauses","        H ",NULL$,"здбЁадцЁ",MAT WAIT) !:
               if CMDKEY><9 then !:
