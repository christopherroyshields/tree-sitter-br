...
enum {
  ...
  sym__numeric_reference = 208,
  sym__string_reference = 209,
  sym_numberelement = 210,
  sym_stringelement = 211,
  sym_stringarray = 212,
  sym_dimension = 213,
  sym_stringreference = 214,
  sym_numberreference = 215,
  sym_range = 216,
  sym_numberarray = 217,
  sym_number = 218,
  aux_sym_source_file_repeat1 = 219,
  aux_sym__multi_line_statement_repeat1 = 220,
  aux_sym_print_statement_repeat1 = 221,
  aux_sym_arguments_repeat1 = 222,
  aux_sym_template_string_repeat1 = 223,
  aux_sym_numberelement_repeat1 = 224,
  aux_sym_stringelement_repeat1 = 225,
  aux_sym_stringarray_repeat1 = 226,
  aux_sym_dimension_repeat1 = 227,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    ...
    [sym_string_expression] = STATE(177),
    [sym_string_binary_expression] = STATE(178),
    [sym_numeric_binary_expression] = STATE(106),
    [sym_numeric_unary_expression] = STATE(106),
    [sym_numeric_primary_expression] = STATE(106),
    [sym_string_primary_expression] = STATE(178),
    [sym_numeric_call_expression] = STATE(123),
    [sym_string_call_expression] = STATE(191),
    [sym_numeric_system_function] = STATE(114),
    [sym_string_system_function] = STATE(192),
    [sym_numeric_user_function] = STATE(114),
    [sym_string_user_function] = STATE(192),
    [sym_template_string] = STATE(191),
    [sym_string] = STATE(191),
    [sym_parenthesized_expression] = STATE(123),
    [sym_numeric_forced_assignment_expression] = STATE(106),
    [sym__numeric_reference] = STATE(74),
    [sym__string_reference] = STATE(191),
    [sym_numberelement] = STATE(74),
    [sym_stringelement] = STATE(191),
    [sym_stringarray] = STATE(74),
    [sym_stringreference] = STATE(191),
  ...
  [3] = {
    ...
    [sym_string_expression] = STATE(176),
    [sym_string_binary_expression] = STATE(158),
    [sym_numeric_binary_expression] = STATE(101),
    [sym_numeric_unary_expression] = STATE(101),
    [sym_numeric_primary_expression] = STATE(101),
    [sym_string_primary_expression] = STATE(158),
    [sym_numeric_call_expression] = STATE(102),
    [sym_string_call_expression] = STATE(169),
    [sym_numeric_system_function] = STATE(86),
    [sym_string_system_function] = STATE(166),
    [sym_numeric_user_function] = STATE(86),
    [sym_string_user_function] = STATE(166),
    [sym_template_string] = STATE(169),
    [sym_string] = STATE(169),
    [sym_parenthesized_expression] = STATE(102),
    [sym_numeric_forced_assignment_expression] = STATE(101),
    [sym__numeric_reference] = STATE(71),
    [sym__string_reference] = STATE(169),
    [sym_numberelement] = STATE(71),
    [sym_stringelement] = STATE(169),
    [sym_stringarray] = STATE(71),
    [sym_stringreference] = STATE(169),
    [sym_numberreference] = STATE(71),
    [sym_numberarray] = STATE(71),
  ...
  [10] = {
    ...
    [sym_numeric_forced_assignment_expression] = STATE(106),
    [sym__numeric_reference] = STATE(75),
    [sym_numberelement] = STATE(75),
    [sym_stringarray] = STATE(75),
    [sym_numberreference] = STATE(75),
    [sym_numberarray] = STATE(75),
    [sym_number] = STATE(123),
    [anon_sym_LPAREN] = ACTIONS(15),
    [anon_sym_PLUS] = ACTIONS(17),
    [anon_sym_DASH] = ACTIONS(17),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stringarray, 3),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stringarray, 3),
  [79] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stringarray, 2),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stringarray, 2),
  ...
  [89] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_stringarray_repeat1, 2), SHIFT_REPEAT(13),
  ...
  [98] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_stringarray_repeat1, 2), SHIFT_REPEAT(12),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dimension, 3),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dimension, 3),
  ...
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dimension, 4),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dimension, 4),
  ...
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numberelement, 4),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_numberelement, 4),
  ...
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_system_function, 1, .production_id = 1),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_numeric_system_function, 1, .production_id = 1),
  ...
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 3),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arguments, 3),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_binary_expression, 3, .production_id = 5),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_numeric_binary_expression, 3, .production_id = 5),
  [175] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_call_expression, 1),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_numeric_call_expression, 1),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_forced_assignment_expression, 3, .production_id = 6),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_numeric_forced_assignment_expression, 3, .production_id = 6),
  ...
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_user_function, 2, .production_id = 4),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_numeric_user_function, 2, .production_id = 4),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_system_function, 2, .production_id = 4),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_numeric_system_function, 2, .production_id = 4),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_unary_expression, 2, .production_id = 3),
  [219] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_numeric_unary_expression, 2, .production_id = 3),
  ...
  [297] = {.entry = {.count = 1, .reusable = false}}, SHIFT(281),
  [299] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [301] = {.entry = {.count = 1, .reusable = false}}, SHIFT(230),
  [303] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stringreference, 2),
  [305] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stringreference, 2),
  [307] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [309] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2),
  [311] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(182),
  [314] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(198),
  [317] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(236),
  [320] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(286),
  [323] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(285),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stringreference, 1),
  [328] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stringreference, 1),
  [330] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [332] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_user_function, 1, .production_id = 1),
  [334] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_user_function, 1, .production_id = 1),
  [336] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_system_function, 1, .production_id = 1),
  [338] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_system_function, 1, .production_id = 1),
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1),
  [342] = {.entry = {.count = 1, .reusable = false}}, SHIFT(227),
  [344] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(181),
  [347] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(197),
  [350] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(238),
  [353] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2),
  [355] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(280),
  [358] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(281),
  [361] = {.entry = {.count = 1, .reusable = false}}, SHIFT(225),
  [363] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_stringelement_repeat1, 2),
  [365] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_stringelement_repeat1, 2),
  [367] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_stringelement_repeat1, 2), SHIFT_REPEAT(14),
  [370] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stringelement, 4),
  [372] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stringelement, 4),
  [374] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stringelement, 6),
  [376] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stringelement, 6),
  [378] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stringelement, 5),
  [380] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stringelement, 5),
  [382] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_stringelement_repeat1, 3),
  [384] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_stringelement_repeat1, 3),
  [386] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_string, 3),
  [388] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_string, 3),
  [390] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_expression, 1),
  [392] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_expression, 1),
  [394] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_system_function, 2, .production_id = 4),
  [396] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_system_function, 2, .production_id = 4),
  [398] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [400] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_string, 2),
  [402] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_string, 2),
  [404] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_binary_expression, 3, .production_id = 5),
  [406] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_binary_expression, 3, .production_id = 5),
  [408] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_call_expression, 1),
  [410] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_call_expression, 1),
  [412] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3),
  [414] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 3),
  [416] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_primary_expression, 1),
  [418] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_primary_expression, 1),
  [420] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_user_function, 2, .production_id = 4),
  [422] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_user_function, 2, .production_id = 4),
  [424] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [426] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_stringelement_repeat1, 2), SHIFT_REPEAT(17),
  [429] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [431] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [433] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_print_statement, 3),
  [435] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_print_statement, 3),
  ...
  [447] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_print_statement_repeat1, 2), SHIFT_REPEAT(4),
  [450] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [452] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_print_statement, 4),
  [454] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_print_statement, 4),
  [456] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_print_statement_repeat1, 2), SHIFT_REPEAT(3),
  [459] = {.entry = {.count = 1, .reusable = true}}, SHIFT(238),
  [461] = {.entry = {.count = 1, .reusable = true}}, SHIFT(280),
  ...
  [471] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__multi_line_statement_repeat1, 2),
  [473] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__multi_line_statement_repeat1, 2), SHIFT_REPEAT(233),
  [476] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__multi_line_statement_repeat1, 2),
  [478] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__multi_line_statement, 1),
  [480] = {.entry = {.count = 1, .reusable = true}}, SHIFT(233),
  [482] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__multi_line_statement, 1),
  [484] = {.entry = {.count = 1, .reusable = true}}, SHIFT(232),
  [486] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__multi_line_statement, 2),
  [488] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__multi_line_statement, 2),
  [490] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__multi_line_statement_repeat1, 2), SHIFT_REPEAT(232),
  [493] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1),
  [495] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 1),
  [497] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_function_definition, 2),
  [499] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_numeric_function_definition, 2),
  [501] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_function_definition, 2),
  [503] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_function_definition, 2),
  ...
  [513] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 2),
  [515] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 2),
  [517] = {.entry = {.count = 1, .reusable = false}}, SHIFT(162),
  [519] = {.entry = {.count = 1, .reusable = false}}, SHIFT(222),
  [521] = {.entry = {.count = 1, .reusable = false}}, SHIFT(50),
  [523] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 3),
  [525] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_definition, 3),
  ...
  [533] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 3),
  [535] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 3),
  [537] = {.entry = {.count = 1, .reusable = false}}, SHIFT(189),
  [539] = {.entry = {.count = 1, .reusable = false}}, SHIFT(221),
  [541] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_template_string_repeat1, 2),
  [543] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_template_string_repeat1, 2), SHIFT_REPEAT(226),
  [546] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_template_string_repeat1, 2), SHIFT_REPEAT(50),
  [549] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 1),
  [551] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 1),
  [553] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_substitution, 3),
  [555] = {.entry = {.count = 1, .reusable = true}}, SHIFT(244),
  [557] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1),
  [559] = {.entry = {.count = 1, .reusable = true}}, SHIFT(237),
  [561] = {.entry = {.count = 1, .reusable = false}}, SHIFT(260),
  ...
  [569] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 2),
  [571] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dimension_repeat1, 2),
  [573] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dimension_repeat1, 2), SHIFT_REPEAT(15),
  ...
  [594] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 3),
  ...
  [604] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_numberelement_repeat1, 2), SHIFT_REPEAT(42),
  [607] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [609] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2),
  [611] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2), SHIFT_REPEAT(8),
  ...
  [636] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_length, 2, .production_id = 2),
  ...
  [664] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 4),
};
